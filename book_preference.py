...
def run_book_preference_analysis(df: pd.DataFrame, target_groups=None, years=None, genres=None, total_sample=6000):
    ...
    with st.expander("📊 전체 장르별 그래프 자세히 보기", expanded=False):
        st.markdown("""
        > - **20대(19~29세)의 수필 선호는 2023년에 급격히 무너졌습니다.**  
        311.8명 → 195.3명으로 **1/3 수준**까지 **급감**한 수치입니다.  
        > - 반면 **30대(30~39세)는 전 연도에 걸쳐 수필을 꾸준히 선택**하고 있으며,  
        2023년에도 **310명 이상**이 수필을 골랐습니다.

        > 👉 이 그래프는 **감성 콘텐츠 중심의 20대**와  
        >     **성찰형·실용형 독서로 넘어간 30대**의 **독서 성향 변화**를 보여줍니다.
        """)
